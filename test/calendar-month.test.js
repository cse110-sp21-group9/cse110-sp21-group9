...
describe('Basic unit tests for monthly calendar ', () => {
  ...
  beforeAll(() => {
	...
	test("Test1: Calendar has correct current month/year", () => {
	...
	// DOM Unit Test 2: Check calendar next month 
	test("Test2: Check calendar correct next month", () => {
	...
	// DOM Unit Test 3: Check calendar previous month
	test("Test3: Check calendar correct previous month", () => {
  ...
  // DOM Unit Test 4: Check calendar next year
	test("Test4: Check calendar correct next year", () => {
	...
	// DOM Unit Test 5: Check calendar previous year
	test("Test5: Check calendar correct next year", () => {
	...
	// DOM Unit Test 6: Check calendar lower month bound (should change year)
	test("Test6: Check previous month in January (should change to December of last year)", () => {
		const backMonth = document.getElementById("backmonth");
	...
	// DOM Unit Test 7: Check calendar upper month bound (should change year) 
	test("Test7: Check next month in December (should change to January of next year)", () => {
		const forwardMonth = document.getElementById("forwardmonth");
		for(let i = 0; i < 13; i++) {
			forwardMonth.click(); 
		}
